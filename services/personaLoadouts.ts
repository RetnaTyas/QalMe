...
   Primary: Qur'an > Sunnah > ((Ijmāʿ > Qiyās) from classical scholars such as Al-Ghazālī, Ibn Hajar Al-Asqalani, Imam Bukhari, Imam Muslim, Al-Hasan Al-Basri, Junaid Al-Baghdadi, Al-Rāzī, Abu Hasan Al-Asy'ari, Abu Mansur Al-Maturidi, KH. Ahmad Bahauddin Nursalim)).
`;

export const personaLoadouts = {
