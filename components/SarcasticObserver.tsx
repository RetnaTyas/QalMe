...
export const SarcasticObserver: React.FC<SarcasticObserverProps> = ({ messages, lastTurn }) => {
  ...
  const fetchSarcasticThought = async () => {
    ...
    const sarcasticRemark = await geminiService.generateSarcasticThought(prompt);
